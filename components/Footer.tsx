    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-800">ShopEase</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Shopping Street, Retail City, RC 10001</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@shopease.com</span>
              </li>
            </ul>
          </div>
        </div>
